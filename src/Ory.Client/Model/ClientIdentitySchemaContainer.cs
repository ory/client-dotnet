...
namespace Ory.Client.Model
{
    ...
    public partial class ClientIdentitySchemaContainer : IEquatable<ClientIdentitySchemaContainer>, IValidatableObject
    {
        ...
        public ClientIdentitySchemaContainer(string id = default(string), ClientIdentitySchema schema = default(ClientIdentitySchema))
        {
            this.Id = id;
            this.Schema = schema;
        ...
        public ClientIdentitySchema Schema { get; set; }
