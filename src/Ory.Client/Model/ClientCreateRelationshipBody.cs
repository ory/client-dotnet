...
namespace Ory.Client.Model
{
    ...
    public partial class ClientCreateRelationshipBody : IValidatableObject
    {
        /// <summary>
        ...
        public ClientCreateRelationshipBody(string varNamespace = default(string), string varObject = default(string), string relation = default(string), string subjectId = default(string), ClientSubjectSet subjectSet = default(ClientSubjectSet))
        {
