...
namespace Ory.Client.Model
{
    ...
    public partial class ClientUpdateLoginFlowBody : AbstractOpenAPISchema, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientUpdateLoginFlowBody" /> class
        /// with the <see cref="ClientUpdateLoginFlowWithSamlMethod" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of ClientUpdateLoginFlowWithSamlMethod.</param>
        public ClientUpdateLoginFlowBody(ClientUpdateLoginFlowWithSamlMethod actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientUpdateLoginFlowBody" /> class
        /// with the <see cref="ClientUpdateLoginFlowWithPasskeyMethod" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of ClientUpdateLoginFlowWithPasskeyMethod.</param>
        public ClientUpdateLoginFlowBody(ClientUpdateLoginFlowWithPasskeyMethod actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientUpdateLoginFlowBody" /> class
        /// with the <see cref="ClientUpdateLoginFlowWithIdentifierFirstMethod" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of ClientUpdateLoginFlowWithIdentifierFirstMethod.</param>
        public ClientUpdateLoginFlowBody(ClientUpdateLoginFlowWithIdentifierFirstMethod actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                if (value.GetType() == typeof(ClientUpdateLoginFlowWithCodeMethod) || value is ClientUpdateLoginFlowWithCodeMethod)
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(ClientUpdateLoginFlowWithIdentifierFirstMethod) || value is ClientUpdateLoginFlowWithIdentifierFirstMethod)
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(ClientUpdateLoginFlowWithLookupSecretMethod) || value is ClientUpdateLoginFlowWithLookupSecretMethod)
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(ClientUpdateLoginFlowWithOidcMethod) || value is ClientUpdateLoginFlowWithOidcMethod)
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(ClientUpdateLoginFlowWithPasskeyMethod) || value is ClientUpdateLoginFlowWithPasskeyMethod)
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(ClientUpdateLoginFlowWithPasswordMethod) || value is ClientUpdateLoginFlowWithPasswordMethod)
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(ClientUpdateLoginFlowWithSamlMethod) || value is ClientUpdateLoginFlowWithSamlMethod)
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(ClientUpdateLoginFlowWithTotpMethod) || value is ClientUpdateLoginFlowWithTotpMethod)
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(ClientUpdateLoginFlowWithWebAuthnMethod) || value is ClientUpdateLoginFlowWithWebAuthnMethod)
                {
                    this._actualInstance = value;
                }
                else
                {
                    throw new ArgumentException("Invalid instance found. Must be the following types: ClientUpdateLoginFlowWithCodeMethod, ClientUpdateLoginFlowWithIdentifierFirstMethod, ClientUpdateLoginFlowWithLookupSecretMethod, ClientUpdateLoginFlowWithOidcMethod, ClientUpdateLoginFlowWithPasskeyMethod, ClientUpdateLoginFlowWithPasswordMethod, ClientUpdateLoginFlowWithSamlMethod, ClientUpdateLoginFlowWithTotpMethod, ClientUpdateLoginFlowWithWebAuthnMethod");
                }
            }
        }
        ...
        /// <summary>
        /// Get the actual instance of `ClientUpdateLoginFlowWithSamlMethod`. If the actual instance is not `ClientUpdateLoginFlowWithSamlMethod`,
        /// the InvalidClassException will be thrown
        /// </summary>
        /// <returns>An instance of ClientUpdateLoginFlowWithSamlMethod</returns>
        public ClientUpdateLoginFlowWithSamlMethod GetClientUpdateLoginFlowWithSamlMethod()
        {
            return (ClientUpdateLoginFlowWithSamlMethod)this.ActualInstance;
        }
        ...
        /// <summary>
        /// Get the actual instance of `ClientUpdateLoginFlowWithPasskeyMethod`. If the actual instance is not `ClientUpdateLoginFlowWithPasskeyMethod`,
        /// the InvalidClassException will be thrown
        /// </summary>
        /// <returns>An instance of ClientUpdateLoginFlowWithPasskeyMethod</returns>
        public ClientUpdateLoginFlowWithPasskeyMethod GetClientUpdateLoginFlowWithPasskeyMethod()
        {
            return (ClientUpdateLoginFlowWithPasskeyMethod)this.ActualInstance;
        }

        /// <summary>
        /// Get the actual instance of `ClientUpdateLoginFlowWithIdentifierFirstMethod`. If the actual instance is not `ClientUpdateLoginFlowWithIdentifierFirstMethod`,
        /// the InvalidClassException will be thrown
        /// </summary>
        /// <returns>An instance of ClientUpdateLoginFlowWithIdentifierFirstMethod</returns>
        public ClientUpdateLoginFlowWithIdentifierFirstMethod GetClientUpdateLoginFlowWithIdentifierFirstMethod()
        {
            return (ClientUpdateLoginFlowWithIdentifierFirstMethod)this.ActualInstance;
        }
        ...
        public static ClientUpdateLoginFlowBody FromJson(string jsonString)
        {
            ...
            {
                // if it does not contains "AdditionalProperties", use SerializerSettings to deserialize
                if (typeof(ClientUpdateLoginFlowWithIdentifierFirstMethod).GetProperty("AdditionalProperties") == null)
                {
                    newClientUpdateLoginFlowBody = new ClientUpdateLoginFlowBody(JsonConvert.DeserializeObject<ClientUpdateLoginFlowWithIdentifierFirstMethod>(jsonString, ClientUpdateLoginFlowBody.SerializerSettings));
                }
                else
                {
                    newClientUpdateLoginFlowBody = new ClientUpdateLoginFlowBody(JsonConvert.DeserializeObject<ClientUpdateLoginFlowWithIdentifierFirstMethod>(jsonString, ClientUpdateLoginFlowBody.AdditionalPropertiesSerializerSettings));
                }
                matchedTypes.Add("ClientUpdateLoginFlowWithIdentifierFirstMethod");
                match++;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into ClientUpdateLoginFlowWithIdentifierFirstMethod: {1}", jsonString, exception.ToString()));
            }
            ...
            {
                // if it does not contains "AdditionalProperties", use SerializerSettings to deserialize
                if (typeof(ClientUpdateLoginFlowWithPasskeyMethod).GetProperty("AdditionalProperties") == null)
                {
                    newClientUpdateLoginFlowBody = new ClientUpdateLoginFlowBody(JsonConvert.DeserializeObject<ClientUpdateLoginFlowWithPasskeyMethod>(jsonString, ClientUpdateLoginFlowBody.SerializerSettings));
                }
                else
                {
                    newClientUpdateLoginFlowBody = new ClientUpdateLoginFlowBody(JsonConvert.DeserializeObject<ClientUpdateLoginFlowWithPasskeyMethod>(jsonString, ClientUpdateLoginFlowBody.AdditionalPropertiesSerializerSettings));
                }
                matchedTypes.Add("ClientUpdateLoginFlowWithPasskeyMethod");
                match++;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into ClientUpdateLoginFlowWithPasskeyMethod: {1}", jsonString, exception.ToString()));
            }
            ...
            {
                // if it does not contains "AdditionalProperties", use SerializerSettings to deserialize
                if (typeof(ClientUpdateLoginFlowWithSamlMethod).GetProperty("AdditionalProperties") == null)
                {
                    newClientUpdateLoginFlowBody = new ClientUpdateLoginFlowBody(JsonConvert.DeserializeObject<ClientUpdateLoginFlowWithSamlMethod>(jsonString, ClientUpdateLoginFlowBody.SerializerSettings));
                }
                else
                {
                    newClientUpdateLoginFlowBody = new ClientUpdateLoginFlowBody(JsonConvert.DeserializeObject<ClientUpdateLoginFlowWithSamlMethod>(jsonString, ClientUpdateLoginFlowBody.AdditionalPropertiesSerializerSettings));
                }
                matchedTypes.Add("ClientUpdateLoginFlowWithSamlMethod");
                match++;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into ClientUpdateLoginFlowWithSamlMethod: {1}", jsonString, exception.ToString()));
            }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            switch(reader.TokenType) 
            {
                ...
                case JsonToken.StartArray:
                    return ClientUpdateLoginFlowBody.FromJson(JArray.Load(reader).ToString(Formatting.None));
                default:
                    return null;
            }
        }
