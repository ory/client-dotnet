...
namespace Ory.Client.Model
{
    ...
    public partial class ClientUpdateLoginFlowBody : AbstractOpenAPISchema, IEquatable<ClientUpdateLoginFlowBody>, IValidatableObject
    {
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                if (value.GetType() == typeof(ClientUpdateLoginFlowWithLookupSecretMethod))
                {
                ...
                {
                    throw new ArgumentException("Invalid instance found. Must be the following types: ClientUpdateLoginFlowWithLookupSecretMethod, ClientUpdateLoginFlowWithOidcMethod, ClientUpdateLoginFlowWithPasswordMethod, ClientUpdateLoginFlowWithTotpMethod, ClientUpdateLoginFlowWithWebAuthnMethod");
                }
            }
        }
