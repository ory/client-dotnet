...
namespace Ory.Client.Model
{
    ...
    public partial class ClientSessionAuthenticationMethod : IEquatable<ClientSessionAuthenticationMethod>, IValidatableObject
    {
        ...
        public ClientSessionAuthenticationMethod(ClientAuthenticatorAssuranceLevel aal = default(ClientAuthenticatorAssuranceLevel), DateTime completedAt = default(DateTime), MethodEnum? method = default(MethodEnum?), string provider = default(string))
        {
            this.Aal = aal;
