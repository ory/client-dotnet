...
namespace Ory.Client.Model
{
    ...
    public partial class ClientCreateProjectBranding : IEquatable<ClientCreateProjectBranding>, IValidatableObject
    {
        ...
        public ClientCreateProjectBranding(string logoType = default(string), string logoUrl = default(string), string name = default(string), ClientProjectBrandingColors theme = default(ClientProjectBrandingColors))
        {
