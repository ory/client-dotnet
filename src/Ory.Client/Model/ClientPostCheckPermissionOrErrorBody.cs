...
namespace Ory.Client.Model
{
    ...
    public partial class ClientPostCheckPermissionOrErrorBody : IValidatableObject
    {
        /// <summary>
        ...
        public ClientPostCheckPermissionOrErrorBody(string varNamespace = default(string), string varObject = default(string), string relation = default(string), string subjectId = default(string), ClientSubjectSet subjectSet = default(ClientSubjectSet))
        {
