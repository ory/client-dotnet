...
namespace Ory.Client.Model
{
    ...
    public partial class ClientGenericErrorContent : IValidatableObject
    {
        ...
        public ClientGenericErrorContent(string debug = default(string), string error = default(string), string errorDescription = default(string), IdEnum? id = default(IdEnum?), string message = default(string), long statusCode = default(long))
        {
            this.Debug = debug;
            this.Error = error;
